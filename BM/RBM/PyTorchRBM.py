...
# Discription: This sees if a user will like a movie 
#               that they have yet to rate.
...
# Converting teh data into Torch tensors
    # tensors - arrays that conntrain a single data type (multi-dimintinal matrix)
...
class RBM():
    # Initalise the class with random weights and biasis
...
# Number of movies ie. number of visable nodes
nv = len(training_set[0])

# Number of hidden nodes ie. number of features 
nh = 100
